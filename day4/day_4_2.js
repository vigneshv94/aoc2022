...
try {
  let total = 0;
  const cleanUpSummary = fs.readFileSync('/Users/vigneshvelu/Desktop/adventOfCode/day4/day_4_2_input.txt', 'utf8').split('\n').slice(0);
...
function checkIfOverlaps(range1, range2) {
    ...
    return range1Length < range1.length || range2Length < range2.length ? 1 : 0;
}